package skywolf46.HumAInity.AI.Seq2Seq.Test;
...
//                        .seed(seed)
//                        // why?
//                        .maxNumLineSearchIterations(nIterations)
//                        .graphBuilder()
//                        .addInputs("additionIn", "sumOut")
//                        .setInputTypes(InputType.recurrent(FEATURE_VEC_SIZE), InputType.recurrent(nIterations))
...
//        net.setListeners(new ScoreIterationListener(1));
        ...
        while (iEpoch < nEpochs) {
            ...
            int[] data = encode_decode_eval(predictions, testData.getFeatures()[0], testData.getLabels()[0]);
            /*
            ...
            */
            ...
            System.out.println();
            System.out.println("Wrong " + data[0] + " / Correct " + data[1] + " in epoch " + iEpoch);
    ...
    private static int[] encode_decode_eval(INDArray predictions, INDArray questions, INDArray answers) {
